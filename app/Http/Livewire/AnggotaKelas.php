...
class AnggotaKelas extends Component
{
    ...
    public function render()
    {
        ...
        $murids = DB::table('detail_murids')->join('murids','murids.id','detail_murids.murid_id')->select('detail_murids.*','murids.name as nama','murids.nis as nis')->where('kelas_id',$this->kelas_id)->where('murids.name','like',$searchParams)->orderBy('murids.name')->get();
