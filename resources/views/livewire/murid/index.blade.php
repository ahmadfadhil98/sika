                    ...
                    <table class="table-fixed w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $murid->genre }}</td>
                                <td>
                                    <button wire:click="edit({{ $murid->id }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded">
                                    Edit
                                    </button>
                                    <button wire:click="delete({{ $murid->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-4 rounded">
                                    Delete
                                    </button>
                                </td>
                            </tr>
