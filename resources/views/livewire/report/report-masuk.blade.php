                ...
                <div class="mt-3 bg-white dark:bg-gray-800 overflow-hidden shadow px-4 py-4">
                    ...
                    <div class="flex mb-4">
                        <div class="w-full md:w-1/2">
                            ...
                            ['class' => 'bg-gray-500 text-white py-2 px-6 mt-4','id' => 'period','wire:change'=>'month()','wire:model'=>'period','placeholder'=>'- Pilih uang masuk semester -'])}}
                            ...
                            <button onclick="location.href='{{ route('report',[$this->period,$this->month,3]) }}'" class="text-sm bg-gray-500 hover:bg-gray-700 text-white py-2 px-6">
                                Laporan
                            </button>
                        </div>
                    </div>
