                ...
                @if ($this->period!=0&&$this->month!=0)
                    ...
                    <div class="flex w-full">
                        ...
                        <div class="w-full grid justify-end">
                            <button onclick="window.open('{{ route('report',[$this->period,$this->month,3]) }}')"  class="transform hover:scale-95 duration-300 text-sm bg-green-500 border border-green-500 hover:bg-green-600 rounded-full text-white py-2 px-7 focus:outline-none shadow-lg flex-shrink-0 flex justify-center items-center">
