    ...
    <div class="max-w-full mx-auto sm:px-6 lg:px-10">
        ...
        <div class="w-full mt-3 px-10 flex">
            <div class="w-1/2 flex">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" class="text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                <a href="{{route('neraca')}}" class="mr-3 hover:underline text-gray-600 text-xs focus:outline-none ml-1.5">
                    Neraca bulan ini?
                </a>
            </div>
            <div class="w-1/2 grid justify-end items-center">
