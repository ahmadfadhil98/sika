    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-5">
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg px-4 py-4">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        ['class' => 'bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-4 rounded mb-2','id' => 'sem','wire:change'=>'eksekusi()','wire:model'=>'sem','placeholder'=>'Pilih Periode...'])}}

                        {{ Form::select('jenis',['asrama' => 'Berdasarkan Asrama','kelas' => 'Berdasarkan Kelas'],null,
                        ['class' => 'bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-4 rounded mb-2','id' => 'jenis','wire:change'=>'eksekusi()','wire:model'=>'jenis','placeholder'=>'Berdasarkan...'])}}
                    </div>
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
