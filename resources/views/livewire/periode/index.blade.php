<div>
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-12">
                ...
                <div class="mt-3 bg-white dark:bg-gray-800 overflow-hidden shadow px-4 py-4">
                    ...
                    <div class="w-full md:w-1/2">
                        <input wire:model="search" type="text" class="shadow appearance-none  w-full py-2 px-3 text-blue-900" placeholder="Cari semester...">
                    </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button wire:click="delete({{ $periode->id }})" class="text-sm bg-red-700 hover:bg-red-900 text-white py-2 px-6">
                                    Delete
                                    </button>
                                </td>
                            </tr>
