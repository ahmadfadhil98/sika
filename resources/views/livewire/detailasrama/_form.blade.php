            ...
            <div  id="form" class="text-center mt-4">
                ...
                <form>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div>
                          <h1 class="font-bold text-center mb-4">Aggota Asrama {{$asrama[$dasrama[$asrama_id]]}}</h1>
                        </div>
                            <div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                  <input wire:model="asrama_id" type="hidden" class="w-full py-2 px-3 text-blue-900" >
                                </div>
                                <div class="mb-2" wire:ignore>
                                  <label for="anggota" class="block">Peserta Didik</label>
